        ...
        <div className="signUpbg">
          <div className="container">
            <div className="signUpBox">
              ...
              <p>
                Hoziroq ro’yhadan o’ting va istalgan kursni tanlang,
                operatorlarimiz siz bilan bog’lanib batafsil malumotga ega
                bo’ling va kelajada talabgir bo’lgan kasb egasiga aylaning!
              </p>
            </div>
            <div className="signUpbox2">
              <div className="signUpForm">
                ...
                <button className="btn--border btn-read btn--animated mt-20">
                  Murojatni yuborish
                </button>
              </div>
            </div>
          ...
          <div className="container">
            <div className="text text1">
              <svg width="64" height="64" viewBox="0 0 64 64" fill="none">
                <path
                  d="M40 60.6666H24C9.51998 60.6666 3.33331 54.4799 3.33331 39.9999V23.9999C3.33331 9.51992 9.51998 3.33325 24 3.33325H40C54.48 3.33325 60.6666 9.51992 60.6666 23.9999V39.9999C60.6666 54.4799 54.48 60.6666 40 60.6666ZM24 7.33325C11.7066 7.33325 7.33331 11.7066 7.33331 23.9999V39.9999C7.33331 52.2933 11.7066 56.6666 24 56.6666H40C52.2933 56.6666 56.6666 52.2933 56.6666 39.9999V23.9999C56.6666 11.7066 52.2933 7.33325 40 7.33325H24Z"
                  fill="#22A4E2"
                />
                <path
                  d="M28.6933 43.6533C27.5733 43.6533 26.5333 43.3866 25.6 42.8533C23.4667 41.6266 22.24 39.12 22.24 35.9466V28.0533C22.24 24.9066 23.4667 22.3733 25.6 21.1466C27.7333 19.92 30.5067 20.1066 33.2533 21.7066L40.1067 25.6533C42.8267 27.2266 44.4 29.5466 44.4 32C44.4 34.4533 42.8267 36.7733 40.1067 38.3466L33.2533 42.2933C31.7067 43.2 30.1333 43.6533 28.6933 43.6533ZM28.72 24.3466C28.2933 24.3466 27.92 24.4266 27.6267 24.6133C26.7733 25.12 26.2667 26.3733 26.2667 28.0533V35.9466C26.2667 37.6266 26.7467 38.88 27.6267 39.3866C28.48 39.8933 29.8133 39.68 31.28 38.8266L38.1333 34.88C39.6 34.0266 40.4267 32.9866 40.4267 32C40.4267 31.0133 39.6 29.9466 38.1333 29.12L31.28 25.1733C30.32 24.6133 29.44 24.3466 28.72 24.3466Z"
                  fill="#22A4E2"
                />
              </svg>
              <svg
                className="smallChanceImg"
                width="48"
                height="48"
                viewBox="0 0 64 64"
                fill="none"
              ...
              <h4>
                Barcha darslar yozib olinadi va darsga sababli qatnasha
                olmaganlarga yuklab beriladi. 🎒
              </h4>
            </div>
            <div className="text text2">
              ...
              <h4>
                Ota-onalar yoki ularning o’rinini bosuvchilar bilan doimiy aloqa
                va habarlov tizimi yo’lga qo’yilgan. 👀
              </h4>
            </div>
          </div>
        </div>
