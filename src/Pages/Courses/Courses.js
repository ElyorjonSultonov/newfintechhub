                        ...
                        <div className="column">
                            <div className="card">
                                <div className="content">
                                    <div className="front">
                                        <img className="profile" width="100%"
                                            src={cardImg1}
                                            alt={Hasan}
                                        />
                        ...
                        <div className="container">
                            ...
                            <div className="PurposeBox2">
                                <div className="PurposeResult">
                                    ...
                                    <h1>
                                        +
                                        {counterOn && <CountUp start={0} isCounting end={245} duration={10} />
                                        }
                                    </h1>
                                    <h5>Bitiruvchi</h5>
                                </div>
                                <div className="PurposeResult">
                                    ...
                                    <h1>
                                        {counterOn && <CountUp start={0} isCounting end={79} duration={10} />
                                        }
                                        %
                                    </h1>
                                ...
                                <div className="PurposeResult">
                                    ...
                                    <h1>
                                        {counterOn && <CountUp start={0} isCounting end={400} duration={20} />
                                        }
                                        $
                                    </h1>
